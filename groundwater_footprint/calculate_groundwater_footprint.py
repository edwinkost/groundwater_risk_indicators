...
#~ fraction_reserved_recharge = pcr.max(0.60, fraction_reserved_recharge)
...
for year in range(start_year, end_year + 1, 1):
    ...
    netcdf_file   = "/scratch-shared/edwinsut/test_stress/abstraction.nc"
...
for year in range(start_year, end_year + 1, 1):
    ...
    netcdf_file   = "/scratch-shared/edwinsut/test_stress/recharge.nc"
...
groundwater_contribution_to_environmental_flow          = pcr.max(0.50, fraction_reserved_recharge * groundwater_recharge)
...
groundwater_stress_map = pcr.ifthen(landmask, \
                         pcr.cover(pcr.areamaximum(groundwater_stress_map, class_map), 0.0))
