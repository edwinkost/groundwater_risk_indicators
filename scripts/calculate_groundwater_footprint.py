...
fraction_reserved_recharge = pcr.readmap("/scratch-shared/edwinhs/groundwater_risk_indicators_wri_deltares_july_2017/fraction_reserved_recharge_rens/reservedrecharge/fraction_reserved_recharge10.5min.map")
# - extrapolation
...
netcdf_setup['title'      ]     = "PCR-GLOBWB output: Groundwater stress at the spatial unit of " + text_unit 
